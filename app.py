...
# Initialize session state for animal types
if 'selected_animal_types' not in st.session_state:
    st.session_state.selected_animal_types = {
        'Dogs': ['All sizes'],
        'species_list': ['Dog']
    }
    
# Initialize session state for boarding products
if 'boarding_products' not in st.session_state:
